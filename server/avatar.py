    ...
    def inference_dash(self, audio_path, fps, unique_id, chunk_duration=DEFAULT_CHUNK_DURATION):
        ...
        with inference_semaphore:
            ...
            def start_dash_stream():
                first_chunk_event.wait()  # wait until at least one segment is ready
                ...
                # Start the dash process in the background without waiting.
                subprocess.Popen(dash_cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                # Manifest file should be generated by the muxer once the process starts.
